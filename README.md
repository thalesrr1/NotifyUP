...
* ⚙️ Configuração centralizada via variáveis de ambiente (`.env`).
...
1.  **Clone o repositório:**
    ...
    ```bash
    git clone [https://github.com/thalesrr1/NotifyUP](https://github.com/thalesrr1/NotifyUP)
    ```
...
7.  **Testando Outros Templates:**
    ...
    ```json
    {
        ...
        "context": {
            ...
            "resetLink": "[http://seu-site.com/redefinir-senha?token=ABC123XYZ](http://seu-site.com/redefinir-senha?token=ABC123XYZ)"
        }
    }
    ```
...
* ️ Desenvolver uma interface frontend para gerenciar configurações e templates.
